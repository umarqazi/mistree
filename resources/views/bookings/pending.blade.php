                        ...
                        <table class="table table-striped dataTable no-footer" id="jsTable" role="grid" aria-describedby="jsTable_info">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting text-center" tabindex="0" aria-controls="jsTable" rowspan="1" colspan="1" aria-label="Estimated Rates: activate to sort column ascending">Estimated Service Charges</th>
                            ...
                            <tbody>                            
                                 @foreach($bookings as $booking)                                
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="text-center">@if(count($booking->services)){{$booking->services->pluck('pivot')->sum('service_rate')}} PKR @endif</td>
